...
void Navigation::showRolesInfo()
{
    ...
    //currentMainWindow = static_cast<QMainWindow*>(this->window());
    //currentMainWindow->setCentralWidget(new RolesNavigation(currentMainWindow));    
    //qDebug()<<this->window();
    //static_cast<MainWindow*>(this->window())->setCentralWidget(rn);
}
